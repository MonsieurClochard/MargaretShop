namespace MargaretShop.HR
{
    public class Employee: IEmployee
    {
        ...
        public int CalculateBonusAndBonusTax(int bonus, out int bonusTax)
        {
            ...
            Console.WriteLine($"Employee got a bonus {bonus} and the tax on bonus is {bonusTax}");
            return bonus;
        }

        public virtual void GiveBonus()
        {
            Console.WriteLine($"{FirstName} {LastName} received a generous bonus of 100!");
        }
